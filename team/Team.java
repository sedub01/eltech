...
public class Team{ // класс-агрегатор
    ...
    public Team(){
        ...
        try{//Ввод инфы из трех файлов
            BufferedReader buf = new BufferedReader(new FileReader(new File("./data/Команда.txt")));
            ...
            buf.close();
            buf = new BufferedReader(new FileReader(new File("./data/Игроки.txt")));
            while (buf.ready()){
            ...
            buf.close();
            buf = new BufferedReader(new FileReader(new File("./data/Даты.txt")));
            while(buf.ready()){
                String v[] = buf.readLine().split(";");
    ...
    public void saveChanges(){
        try{
            FileWriter writer1 = new FileWriter("./data/Даты.txt");
            //writer.write("Привет!\nЯ тестирую Java");
            ...
            FileWriter writer2 = new FileWriter("./data/Игроки.txt");
            for (Footballer boy: list){
            ...
            FileWriter writer3 = new FileWriter("./data/Команда.txt");
